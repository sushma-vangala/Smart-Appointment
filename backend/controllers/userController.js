...
export const bookAppointment = async(req,res) => {
    try {
        ...
        const {userId, id, slotDate, slotTime} = req.body
        const provData = await providerModel.findById(id).select('-password')
        ...
        // save new l\slots data in docData
        await providerModel.findByIdAndUpdate(id,{slots_booked})
...
//api to get user appointments for myappointment page
