  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex items-center'>
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
        <p className='text-2xl font-semi-bold m-auto'>{state==='Sign Up' ? "Create Account" : "User Login"}</p>
        {
        ...
        <button type='submit' className='bg-[var(--primary)] text-white w-full py-2 rounded-md text-base'>{state==='Sign Up' ? "Create Account" : "Login"}</button>
        {
          state==="Sign Up"
